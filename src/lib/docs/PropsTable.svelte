<script lang="ts">
  ...
  const rowsByComponent: Record<string, PropRow[]> = {
    ...
    ClipboardText: [{ prop: 'text', type: 'string', default: '-', description: 'Text copied to the clipboard.' }, { prop: 'copyText', type: 'string', default: '-', description: 'Alternate clipboard value.' }, classRow, restRow],
    ...
    DeleteResource: [{ prop: 'resourceName', type: 'string', default: '-', description: 'Name of the resource being deleted.' }, { prop: 'onDelete', type: '() => void | Promise<void>', default: '-', description: 'Called after confirmation.' }, { prop: 'loading', type: 'boolean', default: 'false', description: 'Shows pending delete state.' }, classRow]
  };
